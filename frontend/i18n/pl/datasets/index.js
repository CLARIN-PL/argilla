export default {
  ...
  pendingActionsWillBeLost: "Oczekujące akcje zostaną utracone po odświeżeniu strony",
   okGotIt: "Ok, rozumiem!",
   ...
   recordCouldHaveNotBeenDiscarded: "rekordy nie mogły zostać odrzucone",
   recordsAreValidated: "rekordy są sprawdzane",
   oneRecordIsValidated: "1 rekord został zatwierdzony",
   recordCouldHaveNotBeenValidated: "rekord nie mógł zostać zatwierdzony",
   labelsAlreadyExist: `Etykiety <b>'{newLabels}'</b> już istnieją na liście etykiet`,
   labelAreUpdated: "Etykiety zostały zaktualizowane!",
   etykietyCouldNotBeSaved: `STATUS:{status} Nie można zapisać etykiet zbioru danych {datasetName} z zadaniem {datasetTask}`,
