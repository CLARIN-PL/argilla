export default {
  ...
  youHaveReached:
    "Osiągnięto koniec danych dla kolejki {recordStatusToFilterWith}",
...
przewodnik</a> dotyczący korzystania z zaawansowanych zapytań.
  ...
  datasetsEmptyDescription: `Aplikacja internetowa Argilla umożliwia rejestrowanie, eksplorowanie i dodawanie adnotacji do danych.<br />
Rozpocznij rejestrowanie danych za pomocą naszego klienta Python lub
<a href="https://docs.rubrix.ml/" target="_blank" >sprawdź dokumentację</a>, aby uzyskać więcej informacji.`,
  ...
  actionNeeded: `Potrzebna akcja: Zapisz etykiety, aby zweryfikować schemat adnotacji. Więcej w
...
`,
  ...
  ifYouHaveVectors:
    " Jeśli masz wektory w swoich rekordach, możesz znaleźć najbardziej podobne rekordy do danego",
  ...
  zeroRulesDefined: "0 reguł zdefiniowanych",
  ...
  precisionDescription:
    "Procent poprawnych etykiet podanych przez regułę w odniesieniu do adnotacji",
  correctDescription:
    "Liczba etykiet, które reguła przewidziała poprawnie w odniesieniu do adnotacji",
  ...
  incorrectDescription:
    "Liczba etykiet, które reguła przewidziała nieprawidłowo w odniesieniu do adnotacji",
